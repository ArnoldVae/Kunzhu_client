  ...
  <div class="dashboard-container">
    <el-container>
      <el-aside width="240px">
        <el-menu v-if="$store.getters.currentUserType === '2'" v-model="isCollapse" class="el-menu-vertical-demo"
          :default-openeds="openeds" @open="handleOpen" @close="handleClose" @select="handleSelect">
          <el-submenu index="0">
            <template slot="title">
              <el-badge is-dot class="item" v-if="pointMyAll || pointFollow || pointQusetions">
                <span>我的项目</span>
              </el-badge>
            ...
            <el-menu-item-group>
              ...
              <el-menu-item index="2">
                <el-badge is-dot class="item" v-if="pointQusetions">
                  <span>已提问项目</span>
                </el-badge>
              ...
              <el-menu-item index="3">
                <template slot="title">
                  <el-badge is-dot class="item" v-if="pointFollow">
                    <span>待反馈项目</span>
                  </el-badge>
        ...
        <el-menu v-if="$store.getters.currentUserType === '1'" v-model="isCollapse" class="el-menu-vertical-demo"
          :default-openeds="openeds" @open="handleOpen" @close="handleClose" @select="handleSelect">
          <el-submenu index="0">
            <template slot="title">
              <el-badge is-dot class="item" v-if="pointMyAll || pointFollow || pointQusetions">
      ...
      <el-main>
        <div v-if="menuTarget === ''">
          <div class="home_content" v-if="projectStep === 1">
            ...
            <div class="content_th" v-if="$store.getters.currentUserType === '2'">
              <el-row>
            ...
            <div class="content_th" v-if="$store.getters.currentUserType === '1'">
              <el-row>
            ...
            <div class="content_tr" v-for="p in projectOptions" :key="p.id">
              <el-row v-if="$store.getters.currentUserType === '2'">
                <el-col :span="9" class="point">
                  <ul>
                    <li>
                      <span style="font-size: 20px; font-weight: bold" v-if="p.readStatus === '0'"
                        @click="showProDetail(p)">{{
                        p.projectTitle
                        }}</span>
                      <span style="font-size: 20px;" v-if="p.readStatus !== '0'" @click="showProDetail(p)">{{
                        p.projectTitle
                        }}</span>
                ...
                <el-col :span="4" class="point">
                  <ul>
                    <li>
                      <span @click="showProDetail(p)" v-if="p.readStatus === '0'">未查看</span>
                      <span @click="showProDetail(p)" v-if="p.readStatus === '1'">已查看</span>
                    </li>
                    <li>
                      <span @click="showProDetail(p)" v-if="p.applyStatus === '1'">已发申请</span>
                      <span @click="showProDetail(p)" v-if="p.applyStatus === '0'">未发申请</span>
                    </li>
                    <li>
          ...
          <div class="home_content" v-if="projectStep === 2">
            <el-row>
              <el-col :span="18">
                <div class="project_detail">
                  ...
                  <div class="content">
                    ...
                    <div class="content_main">
                      <p v-html="selectObj.content"></p>
                    </div>
                    <div class="content_bottom">
                      <span>相关附件:</span>
                      <span   class="name" style="cursor: pointer;" v-for="f in selectObj.attachments" :key="f.projectAttachmentId"  @click="showThisOne(f)">{{ f.title
                        }}</span>
                    </div>
                  </div>
                </div>
                <div class="project_detail">
                  ...
                  <div class="content">
                    <div class="content_main">
                      <div class="content_main_problems" v-for="p in problemOptions" :key="p.questionId">
                        ...
                        <div class="content_main_answer" v-for="a in p.answers" :key="a.answerId">
              ...
              <el-col :span="6">
                <div class="project_sys">
                  <ul>
                    <li>
                      <el-button @click="setQuestions" type="primary">提出问题</el-button>
                    </li>
                    <li>
                      <el-button @click="submitApply" v-if="selectRow.applyStatus === '0'" type="primary" plain>提交申请
                      </el-button>
                    </li>
                    <li>
                      <el-button @click="followApply" type="primary" plain>进度反馈</el-button>
                    </li>
                  </ul>
                </div>
              </el-col>
          ...
          <div class="home_content" v-if="projectStep === 3">
                ...
                <el-row>
                  ...
                  <el-col :span="18">
                    ...
                    <div class="content_right_main">
                      <el-input type="textarea" :rows="14" placeholder="请输入内容" v-model="questionDetail">
                      </el-input>
                    </div>
          ...
          <div class="home_content" v-if="projectStep === 4">
            ...
            <div class="follow">
              <div class="follow_main">
                ...
                <div class="follow_txt">
                  ...
                  <el-input type="textarea" :rows="8" placeholder="请输入内容" v-model="followDetail">
                  </el-input>
        ...
        <div v-if="menuTarget === 'modifyInfo'" class="pwd">
          <el-form :model="ruleForm2" status-icon :rules="rules2" ref="ruleForm2" label-width="100px" 
            ...
            <el-form-item label="真实姓名" prop="realName">
              <el-input v-model="ruleForm2.realName" autocomplete="off" disabled></el-input>
            </el-form-item>
    ...
    <el-dialog append-to-body :close-on-click-modal="false" :before-close="closeAdd" :visible.sync="addFlag"
      title="创建项目" width="48%">
